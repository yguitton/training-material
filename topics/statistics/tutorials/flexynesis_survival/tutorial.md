...
title: Survival Markers of Lower Grade Gliomas
...
>    - {% icon param-file %} *"File to process"*: `out_file1` (output of **Compute** {% icon tool %})
>    - In *"Replacement"*:
...
>        - {% icon param-file %} *"Predicted labels"*: `outfile` (output of **Replace Text** {% icon tool %})
>        - *"Column in the labels file to use for coloring the points in the plot"*: `c9`
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
