...
title: Query a metaplasmidome database to identify and annotate plasmids in metagenomes
zenodo_link: ''
questions:
...
In this tutorial, we use a metaplasmidome database built from public air metagenomes and query it with other air metagenome data that has been assembled.
