...
>    - [`example_image.tiff`](../parameter-tuning/workflows/test-data/example_image.tiff)
>    - [`example_image_ground_truth.tiff`](../parameter-tuning/workflows/test-data/example_image_ground_truth.tiff)
>    
