...
> <hands-on-title> Use regular expression to clean scientificName column </hands-on-title>
>
...
>    - {% icon param-file %} *"Select cells from"*: `Advanced Cut on data xx` (Dataset generated by the previous step)
>    - *"using column"*: `c3` (the column with scientificName)
>    - *"Check"*:
>        - *"Find Regex"*: `^([A-Z][^A-Z(]+)((?<!^).*)$`
>        - *"Replacement"*: `\1`
> 
