...
There's a tutorial describing the steps involved in [annotating a genome with Helixer]({% link topics/assembly/tutorials/genome_annotation/helixer/tutorial.md %}). 
...
There's a tutorial describing the steps involved in [annotating a genome with Braker3]({% link topics/assembly/tutorials/genome_annotation/braker3/tutorial.md %}). 
