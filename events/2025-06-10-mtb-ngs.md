...
program:
  ...
  - section:
    ...
    - type: custom
      name: "**Assessement**: Let us know what you have and have not understood"
      description: |
  ...
  - section:
    description: |
        **Optional materials**: These are produced outside this training by [tbnet](https://www.tbnet.eu/) and [Stop TB Partnership](https://www.stoptb.org/) and [FIND](https://www.finddx.org/), but might be of interest to you.
        ...
        [https://tbksp.who.int/en/node/2701](https://iris.who.int/handle/10665/376284)
  ...
  - section:
    async: true
    description: Once you are done with the tutorial below, share your Galaxy history with us (mandatory for requesting a certificate).
    tutorials:
  ...
  - section:
    async: true
    description: |
      Once you are done with the tutorial below, share your Galaxy history with us (mandatory for requesting a certificate).
    tutorials:
